/*
  ...
  2. Güvenlik
    - Öğretim görevlilerinin randevu oluşturabilmesi için politika güncelleme
...
DROP POLICY IF EXISTS "Lecturers can create appointments" ON appointments;

-- Öğretim görevlilerinin kendi randevularını güncelleyebilmesi
