-- Mevcut "Ertelenen Toplantı" metinlerini "Takip Toplantısı" olarak geri değiştir
UPDATE appointments
SET subject = 'Takip Toplantısı'
WHERE subject = 'Ertelenen Toplantı' AND is_follow_up = true;

-- Mevcut "ertelenen randevu" mesajlarını "devam randevusu" olarak geri değiştir
UPDATE appointments
SET message = 'Akademisyen tarafından oluşturulan devam randevusu'
WHERE message = 'Akademisyen tarafından oluşturulan ertelenen randevu' AND is_follow_up = true;

-- create_follow_up_appointment fonksiyonunu geri güncelle
